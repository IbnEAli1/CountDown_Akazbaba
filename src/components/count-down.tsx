...
export default function Countdown() {
  ...
  // const lagaen ya let lagae marzi
  // [] ya arry hota hai 
  //timeLeft ya is jaisa sub varible name hota hai
  // , 
  // setter funcation (usestate ki vale update karne ho to is ak zarya ho ga) is ko camle case may likha jye ga
  //=
  // UseState (ya react ka predifine funcatin hai)
  // then () is carly brakets may inital value likhi jye gi.
  // State to track if the timer is active or is ko import be karna ho ga react ki libray say.
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-blue-200 dark:bg-gray-900">
      ...
      <div className="bg-black  dark:bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
        ...
        <div className="flex items-center mb-6">
          <Input
            ...
            className="flex-1 mr-4 rounded-md border-gray-300 dark:border-white dark:bg-white dark:text-white"
          />
          <Button
        ...
        <div className="text-8xl font-bold text-white dark:text-gray-200 mb-8 text-center">
          {formatTime(timeLeft)}
        </div>
      ...
      <div className="text-gray-800 text-center font-bold">@Count_Down by AkazBaba <a href="https://www.youtube.com/@akazbaba" ><br /> Click & Subscribe</a>
    </div>
    </div>
  );
}